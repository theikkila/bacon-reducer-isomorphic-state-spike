...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  setInterval(function () {
	    _store.appState.dispatch({ type: 'CHANGE', color: Math.random() });
	  }, 1000);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Wello = __webpack_require__(236);

	var _Wello2 = _interopRequireDefault(_Wello);
	...
	var Routes = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: 'well', component: _Wello2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _store.appState.changes().onValue(function (state) {
	  ...
	  getChildContext: function getChildContext() {
	    return { appState: _store.appState };
	  },
	  render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.appState = exports.initial = undefined;

	var _baconjs = __webpack_require__(232);

	var _baconjs2 = _interopRequireDefault(_baconjs);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var createAppState = function createAppState(reducer, initial) {
	  var bus = _baconjs2.default.Bus();
	  var store = bus.scan(initial, function (state, action) {
	    return reducer(state, action);
	  });
	  store.dispatch = function (action) {
	    return bus.push(action);
	  };
	  return store;
	};

	var initial = exports.initial = typeof window !== 'undefined' ? window.STATE : {};
	...
	var appState = exports.appState = createAppState(rootReducer, initial);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("function" !== "undefined" && __webpack_require__(234) !== null && __webpack_require__(235) != null) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var appstream_dispose = void 0;

	var Wello = _react2.default.createClass({
	  displayName: 'Wello',
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    appstream_dispose = this.context.appState.changes().onValue(function (state) {
	      return _this.setState(state);
	    });
	  },
	  componentWillUnmount: function componentWillUnmount() {
